...
module.exports = {
  ...
  execute(message) {
    ...
    if (queue.playing) {
      ...
      .setAuthor(`${message.author.username} paused the music.`, "https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg")
