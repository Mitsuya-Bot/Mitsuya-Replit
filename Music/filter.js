...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor("Applying: " + args[0], "https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg","https://discord.com/oauth2/authorize?client_id=904032472755499099&permissions=327558298918&scope=bot")).then(msg =>{
