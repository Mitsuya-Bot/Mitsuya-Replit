...
execute(message, args) {
    ...
    queue.textChannel.send(
      new MessageEmbed()
        .setColor("#F0EAD6")
        .setAuthor(`${message.author.username}#${message.author.discriminator} skipped ${args[0]} songs`, "https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg")
    ).catch(console.error);
  }
};
