...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#F0EAD6")
        .setAuthor(`Music Queue ended.`, "https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg")
  ...
  let thumb;
    if (song.thumbnail === undefined) thumb = "https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg";
    else thumb = song.thumbnail.url;

  try {
      let embed = new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor(`Started playing: ${song.title}`,'https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg')
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        let nowPlaying = new MessageEmbed()
          .setAuthor('♪Now playing♪','https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg','http://zone-id.my.id')
      ...
      if (ms > 0 && ms<10000) {
        nowPlaying.addField("\u200b", "**``[" + createBar((ms == 0 ? seek : ms), seek, 25, "▬", "🔘")[0] + "]``**\n**" + "\n[" + new Date(seek * 1000).toISOString().substr(11, 8) + " / " + (ms == 0 ? " ◉ LIVE" : new Date(ms * 1000).toISOString().substr(11, 8))+ "]**" + "\n" + "\n **Time Remaining:**" + "``" + new Date(left * 1000).toISOString().substr(11, 8) + "``", false );
          ...
          .setAuthor("Searching Song...", "https://cdn.discordapp.com/attachments/859452065881653249/906426419012304896/b9f4681d0af088ea8eb009f84bd51e06.jpg").setFooter("Lyrics")
          .setColor("#F0EAD6")
