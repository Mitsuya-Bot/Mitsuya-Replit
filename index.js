...
client.on(`ready`, () => {	
   ...
   ///////////////////////////////
    ////////////IFCHEMPTY//////////
      ...
      client.user.setActivity(`❤️${PREFIX}help | ${client.guilds.cache.size} Guild`, { type: "PLAYING",
      url: "https://www.twitch.tv"});
      client.user.setActivity(`🎶${PREFIX}help | ${client.guilds.cache.size} Guild`, { type: "PLAYING",
      url: "https://www.twitch.tv"});
      client.user.setActivity(`🦋${PREFIX}help | ${client.guilds.cache.size} Guild`, { type: "PLAYING",
      url: "https://www.twitch.tv"});
      client.user.setActivity(`⭐${PREFIX}help | ${client.guilds.cache.size} Guild`, { type: "PLAYING",
